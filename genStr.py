...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/Zero_Discussion'),
                InlineKeyboardButton('Developer', url='https://t.me/Zero_the_kamisama')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/Zero_Projects'),
            ]
        ]
    )
